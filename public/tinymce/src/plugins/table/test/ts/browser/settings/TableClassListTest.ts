  ...
  TinyLoader.setup(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      Logger.t('no class input without setting', GeneralSteps.sequence([
        ...
        tinyUi.sClickOnUi('click table menu', 'div[role="menu"] span:contains("AbstractTable properties")'),
        Chain.asStep({}, [
      ...
      Logger.t('class input with setting', GeneralSteps.sequence([
        ...
        tinyUi.sClickOnMenu('click table menu', 'span:contains("AbstractTable")'),
        tinyUi.sClickOnUi('click table menu', 'div[role="menu"] span:contains("AbstractTable properties")'),
        tinyUi.sWaitForPopup('wait for popup', 'div[aria-label="AbstractTable properties"][role="dialog"]'),
