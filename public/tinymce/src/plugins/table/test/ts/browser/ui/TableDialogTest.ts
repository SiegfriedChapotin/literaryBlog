...
UnitTest.asynctest('browser.tinymce.plugins.table.TableDialogTest', function () {
  ...
  TinyLoader.setup(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      Logger.t('AbstractTable properties dialog (get data from plain table)', GeneralSteps.sequence([
        api.sSetContent('<table><tr><td>X</td></tr></table>'),
        api.sSetCursor([0, 0, 0], 0),
        api.sExecCommand('mceTableProps'),
        Chain.asStep({}, [
          cWaitForDialog('AbstractTable properties'),
      ...
      Logger.t('AbstractTable properties dialog (get/set data from/to plain table, no adv tab)', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable cell properties dialog (get/set data from/to plain table, no adv tab)', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable row properties dialog (get/set data from/to plain table, no adv tab)', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable properties dialog (get/set data from/to plain table, class list)', GeneralSteps.sequence([
        api.sSetSetting('table_class_list', [{ title: 'Class1', value: 'class1' }]),
        api.sSetContent('<table><tr><td>X</td></tr></table>'),
        api.sSetCursor([0, 0, 0], 0),
        api.sExecCommand('mceTableProps'),
        Chain.asStep({}, [
          Chain.fromParent(cWaitForDialog('AbstractTable properties'), [
            Chain.fromChains([
              ui.cAssertDialogContents({
                align: '',
                border: '',
      ...
      Logger.t('AbstractTable properties dialog (get data from full table)', GeneralSteps.sequence([
        api.sSetContent(
      ...
      Logger.t('AbstractTable properties dialog (add caption)', GeneralSteps.sequence([
        api.sSetContent('<table><tr><td>X</td></tr></table>'),
        api.sSetCursor([0, 0, 0], 0),
        api.sExecCommand('mceTableProps'),
        Chain.asStep({}, [
      ...
      Logger.t('AbstractTable properties dialog (remove caption)', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable properties dialog (change size in pixels)', GeneralSteps.sequence([
        api.sSetContent('<table><tr><td>X</td></tr></table>'),
        api.sSetCursor([0, 0, 0], 0),
        api.sExecCommand('mceTableProps'),
        Chain.asStep({}, [
      ...
      Logger.t('AbstractTable properties dialog (change size in %)', GeneralSteps.sequence([
        api.sSetContent('<table><tr><td>X</td></tr></table>'),
        api.sSetCursor([0, 0, 0], 0),
        api.sExecCommand('mceTableProps'),
        Chain.asStep({}, [
      ...
      Logger.t('AbstractTable properties dialog (change: border,cellpadding,cellspacing,align,backgroundColor,borderColor)', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable properties dialog css border', GeneralSteps.sequence([
