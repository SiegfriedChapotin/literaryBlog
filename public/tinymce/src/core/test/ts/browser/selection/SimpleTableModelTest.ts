...
UnitTest.asynctest('browser.tinymce.core.selection.SimpleTableModel', function () {
  ...
  Pipeline.async({}, [
    Logger.t('fromDom/toDom', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable 2x2 with colspan', Chain.asStep({}, [
      ...
      Logger.t('AbstractTable 2x2 with rowspan', Chain.asStep({}, [
      ...
      Logger.t('AbstractTable 3x3 with colspan & rowspan', Chain.asStep({}, [
    ...
    Logger.t('subsection', GeneralSteps.sequence([
      ...
      Logger.t('AbstractTable 2x2 subsection (1,2)-(1,1)', Chain.asStep({}, [
        cFromDomSubSection('<table><tbody><tr><td>A</td><td>B</td></tr><tr><td>C</td><td>D</td></tr></tbody></table>', [0, 1, 0], [0, 0, 0]),
        cAssertWidth(1),
        cAssertHeight(2),
        cAssertModelAsHtml('<table><tbody><tr><td>A</td></tr><tr><td>C</td></tr></tbody></table>')
      ])),
      Logger.t('AbstractTable 3x3 subsection (2,2)-(3,3)', Chain.asStep({}, [
      ...
      Logger.t('AbstractTable 3x3 subsection (3,3)-(2,2)', Chain.asStep({}, [
